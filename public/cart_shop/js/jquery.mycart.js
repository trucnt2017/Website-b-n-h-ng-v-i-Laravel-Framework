...
(function ($) {
  ...
  var ProductManager = (function () {
    ...
    */
    ...
    var addProduct = function (id, name, summary, price, quantity, image,user) {
      var products = getAllProducts();
      if(user!=0)
      {
      products.push({
    ...
    */
    ...
    var setProduct = function (id, name, summary, price, quantity, image,user) {
      ...
      if (!updatePoduct(id)) {
        addProduct(id, name, summary, price, quantity, image,user);
      }
    };
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (options.cartItems && options.cartItems.constructor === Array) {
      ...
      $.each(options.cartItems, function () {
        ProductManager.setProduct(this.id, this.name, this.summary, this.price, this.quantity, this.image,this.user);
      });
    }
    ...
    var drawTable = function () { 
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          '<tr title="' + this.summary + '" data-id="' + this.id + '" data-user="' + this.user +'" data-price="' + this.price + '">' +
    ...
    */
    ...
    // $(document).on('click', "." + classclearproduct, function () {
    //   var products = ProductManager.getAllProducts();
    //     ProductManager.clearProduct();
    //     $cartBadge.text(ProductManager.getTotalQuantity());
    //     $("#" + idCartModal).modal("hide");
    ...
    $(document).on('click', targetSelector, function () {
      ...
      ProductManager.setProduct(id, name, summary, price, quantity, image,user);
      $cartBadge.text(ProductManager.getTotalQuantity());
