	...
	<div class="w3l_related_products">
		<div class="container">
			...
			<ul id="flexiselDemo2">			
					...
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="assert/images/31.jpg" alt=" " class="img-responsive">
								<img src="assert/images/32.jpg" alt=" " class="img-responsive">
								<img src="assert/images/33.jpg" alt=" " class="img-responsive">
								<img src="assert/images/34.jpg" alt=" " class="img-responsive">
								<img src="assert/images/31.jpg" alt=" " class="img-responsive">
								<img src="assert/images/32.jpg" alt=" " class="img-responsive">
								<img src="assert/images/33.jpg" alt=" " class="img-responsive">
								<img src="assert/images/34.jpg" alt=" " class="img-responsive">
				...
				<script type="text/javascript" src="assert/js/jquery.flexisel.js"></script>
		</div>
	</div>
<!-- //dresses -->
@endsection